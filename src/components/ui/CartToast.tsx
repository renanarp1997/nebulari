    ...
    <AnimatePresence>
      {lastAdded && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 8 }}
          className="ecom-toast fixed bottom-6 left-1/2 z-[70] flex w-[calc(100%-2.5rem)] max-w-md -translate-x-1/2 items-center gap-4 border border-border bg-background-elevated px-4 py-3 shadow-product-hover sm:left-auto sm:right-8 sm:translate-x-0"
        >
