...
export function ProductDenseGrid({
  ...
  if (density === "bento") {
    ...
    return (
      <div
        className={`ecom-product-grid grid grid-cols-2 items-start gap-4 sm:gap-4 lg:grid-cols-4 lg:gap-4 ${className}`}
      >
        {hero && (
  ...
  return (
    <div
      className={`ecom-product-grid ecom-dense-grid grid grid-cols-2 items-start gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4 ${className}`}
    >
